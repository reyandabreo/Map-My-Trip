...
import TravelSearch from '@/components/Destination'; // Import the existing TravelSearch component
...
const NewSpots = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Travel Search Component with Popular Spots */}
      <div className="px-8">
        <TravelSearch /> {/* Reuse the existing popular destination component */}
      </div>
